...
```
cd existing_repo
git remote add origin https://git.copernic.cat/aoulad.ben.hmida.el.halka.taufik/snkrz.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.copernic.cat/aoulad.ben.hmida.el.halka.taufik/snkrz/-/settings/integrations)
